...
@Component
public class ChangeScenarioDeactivateHandler implements CommandHandler {

    private final MetaRequestService metaRequestService;

    public ChangeScenarioDeactivateHandler(MetaRequestService metaRequestService) {
